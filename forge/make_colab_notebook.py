...
The notebook embeds the forge Python files as %%writefile cells, so a Colab
...
def build():
    cells = [
        md("# Ilaria — Faza 1 (corpus → tokenizare → antrenare pe H100)\n\n"
           ...
           "o sesiune întreruptă se reia de unde a rămas."),
    ...
    cells += [
        ...
        code("%%bash\n"
             "cd /content/nexus\n"
             f"python forge/train_ilaria.py --data {DRIVE}/train_stream --out /content/speedtest \\\n"
        ...
        code("%%bash\n"
             ...
             f"python forge/train_ilaria.py --data {DRIVE}/train_stream --out {DRIVE}/brain-a \\\n"
             "  --embed-dim 768 --heads 12 --layers 12 --ffn-dim 2688 --ctx 1024 --max-seq-len 1024 --rope --swiglu --dropout 0 \\\n"
